                    ...
                    $('#movie-list').append(`
                        <div class="col-md-4">
                            <div class="card mb-3">
                                ...
                                <a href="#" class="card-link see-detail2" data-toggle="modal" data-target="#exampleModal" data-id="${data.id}" data-url="https://api.themoviedb.org/3/movie/${data.id}">See Detail</a>
                                </div>
                            </div>
                        </div>
                    `);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">Languege : `+ movie.original_language + `</li>                 
                                <li class="list-group-item">Durations : `+ movie.runtime + ` minutes</li>                 
